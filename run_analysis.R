...
#change working directory to samsung
rootdir=paste(getwd(),"/","samsung",sep="")
setwd(rootdir)
...
rootdir=paste(getwd(),"/",foldername,sep="")
setwd(rootdir)
...
# write dataset onto root directory ad TidyDataset.txt
dir=getwd()
